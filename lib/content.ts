...
export const stackGroups: StackGroup[] = [
  ...
  { label: { en: "Scientific workflows", es: "Flujos científicos" }, items: [
    { name: "Conda", icon: null, badge: "CONDA" },
    { name: "Mamba", icon: null, badge: "MAMBA" },
    { name: "Snakemake", icon: null, badge: "SMK" },
    { name: "Biopython", icon: null, badge: "BIO" },
    { name: "FastQC", icon: null, badge: "QC" },
    { name: "SPAdes", icon: null, badge: "SPAD" },
    { name: "BUSCO", icon: null, badge: "BUSCO" },
    { name: "BLAST", icon: null, badge: "BLAST" },
    { name: "MultiQC", icon: null, badge: "MQ" },
  ] },
...
export const stackProof: StackProof[] = [
  ...
  },
  {
    ...
    detail: { en: "BP-SBS and FungaPlasmidDetect · Python · Bash · Conda · Mamba · Snakemake · Perl · R · Biopython · FastQC · SPAdes · BUSCO · BLAST", es: "BP-SBS y FungaPlasmidDetect · Python · Bash · Conda · Mamba · Snakemake · Perl · R · Biopython · FastQC · SPAdes · BUSCO · BLAST" },
  },
  {
