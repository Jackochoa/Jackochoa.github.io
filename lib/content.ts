 ...
 * component) or null when the set has no clean brand icon → wordmark render.
 * `declared: true` marks tools the author works with but that are not present
 * in the four local case-study repos — kept honest, styled dimmer. */
export type StackEntry = { name: string; icon: string | null; declared?: boolean };
...
export const stackGroups: StackGroup[] = [
  ...
  { label: { en: "Data", es: "Datos" }, items: [
    ...
    { name: "Azure SQL", icon: null, declared: true },
  ] },
  { label: { en: "Cloud / Infra", es: "Cloud / Infra" }, items: [
    { name: "AWS", icon: null, declared: true },
    { name: "GCP", icon: "siGooglecloud", declared: true },
    { name: "Azure", icon: null, declared: true },
    { name: "OCI", icon: null, declared: true },
    { name: "Firebase", icon: "siFirebase", declared: true },
    { name: "Docker", icon: "siDocker" },
  ] },
  { label: { en: "Tooling", es: "Tooling" }, items: [
    { name: "Git", icon: "siGit" },
  ] },
];

export const stackNote = {
  en: "Verified in these projects · cloud & Azure SQL from broader practice.",
  es: "Verificado en estos proyectos · cloud y Azure SQL de práctica más amplia.",
};
