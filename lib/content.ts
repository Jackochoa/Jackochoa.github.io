...
const copy = {
  en: {
    ...
    process: { kicker: "Process", title: "A clear path through uncertain work.", intro: "The method is lightweight enough for a small team and rigorous enough for a product people depend on. Each phase leaves a concrete artifact behind, not just a conversation.", artifactLabel: "Artifact", phases: [
      ["Discover", "Map the people, problem, constraints, and evidence before proposing a solution.", "Actor map", "Who decides, who uses the system day to day, and who pays if it fails."],
      ["Design", "Shape the content and interface around the decisions users actually need to make.", "Initial architecture", "The system's boundaries and the contracts between its parts, before the first screen gets built."],
      ["Build", "Deliver a vertical slice, keep the architecture legible, and use automation where it earns its place.", "Vertical slice", "A thin, complete cut of the product — interface to data — working end to end before the rest gets built out."],
      ["Verify", "Review behavior, keyboard access, performance, security, and maintainability before calling it done.", "Risk matrix and tests", "What can fail, how bad it would be, and what automated or manual test covers it."],
      ["Evolve", "Document the reasoning so the product can keep moving after handoff.", "Handoff documentation", "Why each decision was made, so the work can continue without depending on me to explain it in person."],
    ], close: "The goal is not more software. It is less uncertainty between an idea and its useful form." },
    contact: {
      kicker: "Contact",
  ...
  es: {
    ...
    home: {
      ...
      contact: ["¿Hay una parte difícil que necesita avanzar?", "Trae el contexto. Encontramos la forma.", "Puedes escribirme por correo o WhatsApp."],
    },
    ...
    process: { kicker: "Proceso", title: "Un camino claro por trabajo incierto.", intro: "El método es liviano para un equipo pequeño y riguroso para un producto del que la gente depende. Cada fase deja un artefacto concreto, no solo una conversación.", artifactLabel: "Artefacto", phases: [
      ["Descubrir", "Mapear personas, problema, restricciones y evidencia antes de proponer solución.", "Mapa de actores", "Quién decide, quién usa el sistema día a día y quién paga si falla."],
      ["Diseñar", "Dar forma a contenido e interfaz alrededor de las decisiones reales del usuario.", "Arquitectura inicial", "Los límites del sistema y los contratos entre sus partes, antes de construir la primera pantalla."],
      ["Construir", "Entregar un slice vertical, mantener arquitectura legible y automatizar donde valga la pena.", "Slice vertical", "Un corte delgado y completo del producto —de la interfaz a los datos— funcionando de punta a punta antes de ampliar el resto."],
      ["Verificar", "Revisar comportamiento, teclado, rendimiento, seguridad y mantenimiento antes de darlo por hecho.", "Matriz de riesgos y pruebas", "Qué puede fallar, qué tan grave sería y qué prueba automatizada o manual lo cubre."],
      ["Evolucionar", "Documentar el criterio para que el producto siga avanzando después de la entrega.", "Documentación de entrega", "Por qué se tomó cada decisión, para que el trabajo pueda continuar sin depender de que yo lo explique en persona."],
    ], close: "El objetivo no es más software. Es menos incertidumbre entre una idea y su forma útil." },
    contact: {
      kicker: "Contacto",
      title: "Cuéntame qué necesita avanzar.",
      intro: "Mientras más contexto traigas —los usuarios, la restricción, la parte que está trabada— más útil será mi primera respuesta.",
    },
